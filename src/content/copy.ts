...
export const booking = {
  en: {
    ...
    fields: {
      name:    { label: 'Your name',           ph: 'e.g. Mariam Davitashvili' },
      contact: { label: 'Email or phone',      ph: 'e.g. mariam@stamba.ge or +995 555 12 34 56' },
      date:    { label: 'When is the event?',  ph: 'e.g. 12 June 2026' },
      venue:   { label: 'Where?',              ph: 'e.g. Stamba Hotel, Tbilisi' },
      guests:  { label: 'How many people?',    ph: 'e.g. 24' },
  ...
  ka: {
    ...
    fields: {
      name:    { label: 'შენი სახელი',                       ph: 'მაგ. მარიამ დავითაშვილი' },
      contact: { label: 'ელფოსტა ან ტელეფონი',              ph: 'მაგ. mariam@stamba.ge ან +995 555 12 34 56' },
      date:    { label: 'როდის არის ღონისძიება?',           ph: 'მაგ. 12 ივნისი 2026' },
      venue:   { label: 'სად?',                              ph: 'მაგ. სტამბა, თბილისი' },
      guests:  { label: 'რამდენი სტუმარი?',                  ph: 'მაგ. 24' },
