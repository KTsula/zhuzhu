...
export const tastedUs = {
  ...
  ka: {
    ...
    aboutBody: 'ვაწყობთ კოქტეილ-დესერტების მაგიდებს ღონისძიებებზე — ქორწილებზე, ბრენდის საღამოებზე, კერძო ვახშმებზე — მთელ თბილისში. ღიად ვართ საერთაშორისო კოლაბორაციებისთვისაც — ნებისმიერ ადგილას, სადაც ჟელეს დაყენება ღირს.',
    menuCta: 'სრული მენიუ  →',
    ...
    sharePitchText: 'ჟუჟუ — კოქტეილ-დესერტები, თბილისში ხელით აწყობილი. არ სვამ — ლუკმად აგემოვნებ. დაჯავშნე შენი მომდევნო ღონისძიებისთვის:',
...
export const aboutPage = {
  ...
  ka: {
    ...
    origin: [
      ...
      'სამშობლოში დაბრუნებულმა ორ მეგობარს დაურეკა. ანა — ქიმიის შეყვარებული, სკოლის ქიმიის ოლიმპიადების გამარჯვებული, რომელმაც ზუსტად იცის, რატომ ჩერდება ან „ტირის“ კუბი. ლადო — შეფი, რომელიც თბილისის სასტუმროს სამზარეულოში მუშაობს. მათი ძლიერი მხარეები ცოტა მეტისმეტადაც კარგად ერგებოდა ერთმანეთს.',
...
export const founders = [
  {
    ...
    bio: {
      en: 'IE Business School; interned at Google; now building products at Bending Spoons in Milan. Keti runs the brand surface — the site, the pricing — and what the world sees and clicks.',
      ka: 'IE Business School; სტაჟირება Google-ში; ახლა პროდუქტებზე მუშაობს Bending Spoons-ში, მილანში. ქეთი მართავს ბრენდის ხილულ მხარეს — საიტს, ფასებს — იმას, რასაც სამყარო ხედავს და რაზეც აჭერს.',
    },
    accent: 'rgba(196, 140, 70, 0.30)',
  },
  {
    name: { en: 'Anna', ka: 'ანა' },
    role: { en: 'Recipe chemistry & quality control', ka: 'რეცეპტების ქიმია და ხარისხის კონტროლი' },
    bio: {
      en: 'A chemistry obsessive — a high-school chem-olympiad standout — who treats every recipe like a lab. Anna keeps the cube together — the gelatine, the acid, the standards — and the kitchen on the right side of HACCP.',
      ka: 'ქიმიის შეყვარებული — სკოლის ქიმიის ოლიმპიადების გამორჩეული მონაწილე — რომელიც ყოველ რეცეპტს ლაბორატორიასავით უდგება. ანა კუბს ფორმას უნარჩუნებს — ჟელატინი, მჟავიანობა, სტანდარტები — და სამზარეულოს HACCP-ის წესებთან აწყობს.',
    },
    accent: 'rgba(220, 170, 70, 0.32)',
  },
  {
    ...
    bio: {
      ...
      ka: 'შეფი თბილისის Radisson-ის სამზარეულოში. ლადო თავად საკვებს მართავს — რეცეპტები, ტემპერატურა, გემო, ყოველი კუბი ყოველ თეფშზე — და ფოტოების უკან მდგარი ობიექტივი.',
    },
