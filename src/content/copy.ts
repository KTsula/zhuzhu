...
export const tastedUs = {
  ...
  ka: {
    ...
    successSub: 'გინდა მეგობარსაც გააგებინო? თუ ვინმეს წინ ქორწილი, დაბადების დღე ან კორპორატიული საღამო აქვს, გაუზიარე ქვემოთ მოცემული ბმული.',
    ...
    shareText: 'ეს გუშინ თბილისში გავსინჯე — შენი შემდეგი ღონისძიებისთვის ნამდვილად ღირს.',
    ...
    perks: [
      ...
      },
      {
        ...
        body: 'იცი ვინმე, ვისაც წინ ქორწილი, დაბადების დღე ან კორპორატიული საღამო აქვს? გადაუგზავნე შენი ბმული — ეს ზრდაში გვეხმარება, ჩვენ კი მათ ვუფრთხილდებით, ვინც ახალ ადამიანებს გვაცნობს.',
        microprint: 'შენი გასაზიარებელი ბმული სიაში დამატების შემდეგ გამოჩნდება.',
        cta: null,
        href: null,
      },
    ],
...
export const founders = [
  {
    ...
    bio: {
      ...
      ka: 'IE Business School; სტაჟირება Google-ში; ახლა პროდუქტებზე მუშაობს მილანის Bending Spoons-ში. ქეთი ბრენდის ხილულ მხარეს უძღვება — საიტს, ფასებს და ყველაფერს, რასაც ადამიანები ხედავენ და აჭერენ.',
    },
    accent: 'rgba(196, 140, 70, 0.30)',
  },
  {
    ...
    bio: {
      ...
      ka: 'ქიმიაზე შეყვარებული — სკოლის ქიმიის ოლიმპიადების გამორჩეული მონაწილე — რომელიც ყოველ რეცეპტს ლაბორატორიასავით უდგება. ანა კუბს ფორმას უნარჩუნებს — ჟელატინი, მჟავიანობა, სტანდარტები — და სამზარეულოს HACCP-ის წესებთან შესაბამისობაში ამყოფებს.',
    },
    accent: 'rgba(220, 170, 70, 0.32)',
  },
  {
...
export const pageMeta = {
  home: {
    ...
    ka: { title: 'ჟუჟუ — კოქტეილ-დესერტები · თბილისის ატელიე',
          desc: 'ხელით აწყობილი კოქტეილ-დესერტები თბილისში. ნიგვზის ჩურჩხელა, თაფლის ჭაჭა, ქინძის ჯინი — ქორწილებისთვის, ბრენდის საღამოებისა და სხვა ღონისძიებებისთვის.' },
  },
  menu: {
