...
function confirmation(name: string, lang: 'en' | 'ka') {
  ...
  const t = lang === 'ka'
    ? {
        ...
        hiText: `მადლობა, ${name}.`,
        hiHtml: `მადლობა, ${safe}.`,
        body: 'თქვენი მოთხოვნა მივიღეთ და ერთ სამუშაო დღეში გიპასუხებთ — მენიუს პირველ ვერსიასა და ფასს გამოგიგზავნით.',
        tasting: 'დიდი ღონისძიებისთვის წინასწარ დეგუსტაციის მოწყობაც შეგვიძლია — უბრალოდ უპასუხეთ ამ წერილს.',
